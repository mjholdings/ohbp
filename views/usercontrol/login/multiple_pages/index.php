...
OvanCare
    ...
    <div class="wlc-hero-area" style="background: url(<?= $heroImage ?>) no-repeat scroll center center / cover;">
      ...
      <?php if( current_url() != site_url('/login') &&OvanCarerl() != site_url('/register') && current_url() != site_url('/register/vendor') && current_url() != site_url('/forget-password') && current_url() != site_url('/terms-of-use')){ ?>
OvanCare
...
<!-- Affiliate Plan-->
OvanCare
<div class="affiliate-plOvanCare
OvanCare
    <div class="containeOvanCare
OvanCare
...
OvanCare
        <?php OvanCare
OvanCare
        $plans = App\MemOvanCaren::select('membership_plans.*','award_level.sale_comission_rate')->join('award_level','award_level.id','=','membership_plans.level_id','left')->where('status',1)->get()->toArray();
OvanCare
...
<div class="single-price-table basic-saturn">
    ...
    ?>
OvanCare
<div class="header-plan OvanCarer py-4">
OvanCare
    <h4 class="mb-3" styOvanCare <?= $plan['label_background'] ?>;">
OvanCare
        <?= $plan['name'] ?>
...
OvanCare
<?php } ?>OvanCareOvanCareOvanCareOvanCareOvanCare
...
OvanCare
        </h5>OvanCareOvanCareOvanCareOvanCareOvanCare
...
OvanCareOvanCare
    ...
    if(!isset($plansAvailabOvanCareOvanCare
OvanCare
    ?>
    ...
    <div class="col-lg-4">
        ...
        <div class="single-price-table basic-saturn">
OvanCareOvanCare
            <div class="price-discount"> <?= __('front.save') ?> 90%</div>OvanCare
