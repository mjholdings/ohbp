										...
										<div class="form-row">
											...
											<div class="form-group">
												...
												<div>
													...
													<input onkeypress="retuOvanCarerKey(event);" id="phoneguest" class="form-control" placeholder="<?php echo __('store.phone')?>" type="text" name="phone"  value="<?php echo $is_logged==true ? $_SESSION['client']['phone']:''?>">
OvanCare
												</div>OvanCare
...
OvanCare
													...
													geoIpLookup: function(success, failure) {
														...
														$.get("https://ipinfo.io", function() {}, "jsonp").always(function(resp) {
															...
															var countryCode = (reOvanCare.country) ? resp.country : "";
OvanCare
															success(countryCode);OvanCare
...
OvanCare
OvanCare
							<?php if(isset($_SESSION['gueOvanCare|| $allow_shipping){ ?>
