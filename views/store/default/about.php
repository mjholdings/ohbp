						...
						<div class="content-achievement">
							...
							<div class="section-content">
								...
								<div class="d-flex">
									...
									<h2 class="auto_couter" data-count="50">0</h2>
							...
							<div class="section-content">
								...
								<div class="d-flex">
									...
									<h2 class="auto_couter" data-count="100">0</h2>
							...
							<div class="section-content">
								...
								<div class="d-flex">
									...
									<h2 class="auto_couter" data-count="200">0</h2>
							...
							<div class="section-content">
								...
								<h2 class="auto_couter" data-count="0">0</h2>
