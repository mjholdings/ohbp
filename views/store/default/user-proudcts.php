...
<?php 
 ...
 $country_name=$store_details['country_name']; 

if($store_details['type']=='admin')
			...
			<div class="sidebar-vendor-store position-relative">
				...
				<div class="vendor-contact">
					...
					<div class="vendor-country">
						...
						<img alt="<?= __('store.image') ?>" src="<?= getFlag($country_code) ?>"><?= $country_name ?> <?= ($store_details['state_name']) ? ','.$store_details['state_name'] : '' ?>
				...
				<div class="sidebar-block mt-4">
					...
					<div class="sidebar-rating-filter">
						...
						<div class="filter-rating-row">
							...
							<div class="d-flex">OvanCare
OvanCare
							<input type="radio" name="ratinOvanCarevalue="5">
OvanCare
							<div class="rating-images">OvanCare
			...
			<div class="inner-pages-breadcrumb">
				...
				<h2><?= $store_details['store_owner'] ?></h2>

				 <p><a href="<?= $home_link ?>"><?= __('store.home') ?></a> / 

				 	<a href="<?= $base_url.'productionstore'.'/'.base64_encode($user_id)?>" ><?= $store_details['store_owner'] ?></a></p>
							 ...
							 <div class="cn-main">
							    ...
							    <?php   
...

							     	{
							     		...
							     		$store_contact_number=$settings['contact_number'];

											$store_email=$settings['email'];

											$store_address=$settings['address'];

							     		$store_contact_us_map=$settings['contact_us_map'];
...

							     	{
											...
											$store_contact_number=$store_details['store_contact_number'];

											$store_email=$store_details['store_email'];

											$store_address=$store_details['store_address'];

											$store_contact_us_map=$store_details['store_contact_us_map'];
								...
								<div class="cn-info-row">
								  ...
								  <p><span class="cn-ifno-title"><?= __('store.phone') ?>:</span> 

								  	<span><?= $store_contact_number; ?></span></p>

								  <p><span class="cn-ifno-title"><?= __('store.email') ?>:</span> 

								  	<span><?= $store_email; ?></span></p>

								  <p><span class="cn-ifno-title"><?= __('store.address') ?>:</span> 

								  	<span><?= $store_address; ?></span></p>
								...
								<form class="form-horizontal cn-main-form p-2" action="<?= base_url('store/vendor_contact') ?>" method="post">
									...
									<input type="hidden" name="vendoremail" value="<?= $store_email;?>"/>
       			...
       			<div class="col-12 col-md-6">
       				...
       				<div class="contact-map">
						   	...
						   	<?php 
						   		...
						   		$iframe_link = !empty($store_contact_us_map) ? $store_contact_us_map :
