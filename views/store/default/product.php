            ...
            <div class="product-content-detail">
                ...
                <div class="content">
                    ...
                    <div class="under">
                        ...
                        <!--                  <a href="--><? //= base_url('store/' . $user['store_slug']);
                    ...
                    if (isset($product['product_variations']) && !empty($product['product_variations']))OvanCareOvanCareOvanCareOvanCare
...
<section class="related-products">
    ...
    <div class="container">
        ...
        <div class="product-row product-grid-mjj product-list-related">
