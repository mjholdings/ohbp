...
?>
<link rel="stylesheet" type="text/css" href="<?= base_url('/assets/plugins/chartist/css/chartist.min.css') ?>?v=<?= av() ?>">
<script type="text/javascript" src="<?= base_url('assets/plugins/chartist/js/chartist.min.js') ?>"></script>
<link rel="stylesheet" type="text/css" href="<?= base_url('/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.css') ?>?v=<?= av() ?>">
        ...
        <div class="row">
            <div class="col-xl-3">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span class="counter mt-0 ajax-vendor_wallet_accept_amount  badge bg-primary cursor-pointer rounded-pill float-center" style='width: 50px;right:0;'><?= c_format($totals['vendor_wallet_accept_amount']) ?></span>
                </li>
            </div>
            ...
            <div class="col-xl-3">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span class="counter mt-0 ajax-vendor_wallet_request_sent_amount  badge bg-primary cursor-pointer rounded-pill float-center" style='width: 50px;right:0;'><?= c_format($totals['vendor_wallet_request_sent_amount']) ?></span>
                </li>
            ...
            <div class="col-xl-3">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span class="counter mt-0 ajax-vendor_wallet_unpaid_amount  badge bg-primary cursor-pointer rounded-pill float-center" style='width: 50px;right:0;'><?= c_format($totals['vendor_wallet_unpaid_amount']) ?></span>
                </li>
            </div>
            ...
            <div class="col-xl-3">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span class="counter  ajax-vendor_order_count mt-0 badge bg-primary cursor-pointer rounded-pill float-center" style='width: 50px;right:0;'><?= (int)$totals['vendor_order_count'] ?></span>
                </li>
            </div>
        </div>
    </div>
        ...
        <li class="list-group-item list-group-item-white font-weight-bold" style="text-align:center;"><?php echo __('admin.admin_statistics') ?></li>
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="counter mt-0 badge bg-primary ajax-user_count cursor-pointer rounded-pill float-center btn-window2" data-log="member" style='width: 50px;right:0;'>
                                            <?php echo !empty($user_count) ? count($user_count) : '0'; ?></span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <?php echo __( 'admin.online_admins' ) ?></span>
                                            <div id="online_admin">
                                                <span class="counter count mt-0 badge bg-primary cursor-pointer rounded-pill float-center" style='width: 50px;right:0;'>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="counter ajax-full_hold_action_count mt-0 badge bg-primary cursor-pointer rounded-pill float-center btn-window2" data-log="hold_actions" style='width: 50px;right:0;'>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="counter mt-0 ajax-hold_orders badge bg-primary cursor-pointer rounded-pill float-center btn-window2" data-log="hold_orders" style='width: 50px;right:0;'>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="counter mt-0 ajax-full_digital_orders badge bg-primary cursor-pointer rounded-pill float-center btn-window2" data-log="orders" style='width: 50px;right:0;'>
                                            <?= (int)$totals['full_digital_orders'] ?></span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <a href="<?= base_url('integration/orders') ?>"> <?php echo __('admin.external_inte_order') ?></a></span>
                                            <span class="counter mt-0 badge bg-primary cursor-pointer rounded-pill float-center ajax-external_inte_order btn-window2" data-log="ex_orders" style='width: 50px;right:0;'>
                                            <?= (int)$totals['external_inte_order'] ?></span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <a href="<?= base_url('admincontrol/mywallet/') ?>"><?= __('admin.vendor_on_hold amount') ?> </a></span>
                                            <span class="counter mt-0 ajax-vendor_wallet_on_hold_amount  badge bg-primary cursor-pointer rounded-pill float-center" style='width: 50px;right:0;'><?= c_format($totals['vendor_wallet_on_hold_amount']) ?></span>
                                        </li>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="badge bg-primary cursor-pointer rounded-pill ajax-_t_paid_comm"><?php echo c_format($_t_paid_comm) ?></span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <i class="fa fa-circle"> <?= __('admin.total_unpaid_commition') ?> </i>
                                            <span class="badge bg-primary cursor-pointer rounded-pill ajax-_t_unpaid_comm"><?php echo c_format($_t_unpaid_comm) ?></span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <i class="fa fa-circle"> <?= __('admin.total_in_request_commition') ?></i>
                                            <span class="badge bg-primary cursor-pointer rounded-pill ajax-_t_request_comm"><?php echo c_format($_t_request_comm) ?></span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <i class="fa fa-circle"> <?= __('admin.total_affiliates_comm') ?> </i>
                                            <span class="badge bg-primary cursor-pointer rounded-pill ajax-_t_total_commission"><?php echo c_format($_t_total_commission) ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
function renderIntegrationChart(json){
    if(json){
        ...
        var html = '<div class="tab-content"><div class="text-center mt-5">\
            <div class="d-flex justify-content-center align-items-center flex-column mt-5">\
                <i class="fas fa-exchange-alt fa-5x text-muted"></i>\
                <h3 class="text-muted"><?= __("admin.no_data_found") ?></h3>\
            </div>\
