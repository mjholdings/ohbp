...
<div class="left-menu sidebar sidebar-offcanvas admin_side_bar_color">
  ...
  <div class="scroll-bar d-block sidebar">
    <ul class="navbar-nav scroll-wrap navbar-height admin_side_bar_color">
      ...
      <?php if ($userdetails['id'] == 1 || $userdetails['role'] == 'admin') : ?>
        <!-- Quản lý shop -->
        <li class="nav-item dropdown">
      ...
      <li id="sidebar_store" class="nav-item dropdown" <?= $sidebar_data['store_is_enable'] == 0 ? 'style="display:none;"' : ''; ?>>
        ...
        <div class="dropdown-menu">
          ...
          <?php if ($userdetails['id'] == 1 || $userdetails['role'] == 'admin' || $userdetails['role'] == 'SA' || $userdetails['role'] == 'account') : ?>
      ...
      <?php if ($userdetails['id'] == 1 || $userdetails['role'] == 'admin') : ?>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <?php if ($userdetails['id'] == 1 || $userdetails['role'] == 'admin' || $userdetails['role'] == 'SA') : ?>
              <!-- Lịch sử đơn hàng -->
      ...
      <li class="nav-item dropdown">
        <?php if ($userdetails['id'] == 1 || $userdetails['role'] == 'admin' || $userdetails['role'] == 'account') : ?>
