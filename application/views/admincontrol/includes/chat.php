...
<h2 class="chat-header">
    ...
    <span class="btn btn-xs btn-success" id="current_status"><?= __('admin.online') ?></span>
    ...
    <ul class="dropdown-menu">
        ...
        <li>
            <a href="javascript: void(0);" id="edit-profile">
              <span class="pull-left"><?= __('admin.profile') ?></span>
        ...
        <li>
            <a href="javascript: void(0);" id="change-password">
              <span class="pull-left"><?= __('admin.change_password') ?></span>
        ...
        <li>
            <a href="javascript: void(0);">
              <div class="btn-group btn-toggle status-btn-group"> 
                <button class="btn btn-xs btn-success"><?= __('admin.online') ?></button>
                <button class="btn btn-xs btn-default"><?= __('admin.offline') ?></button>
              </div>
            </a>
        </li>
        <li class="divider"></li>
        <li>
            <a href="javascript: void(0);" id="logout">
              <span class="pull-left"><?= __('admin.sign_out') ?></span>
...
<div class="chat-group">
 <strong><?= __('admin.friends') ?></strong>
