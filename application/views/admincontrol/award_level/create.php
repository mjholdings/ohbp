                    ...
                    <div class="form-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="recruitment_number" min="0" step="1" placeholder="<?= __('Số lượng tuyển') ?>">
                                </div>
                                <p class="error-message"></p>
                            </div>
                            <div class="col-md-3 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text refer-reg-symball">%</span>
                                    <input type="number" class="form-control" name="sale_comission_direct" min="0" step="0.01" placeholder="<?= __('Hoa hồng trực tiếp') ?>">
                                </div>
                                <p class="error-message"></p>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text refer-reg-symball">%</span>
                                    <input type="number" class="form-control" name="sale_comission_indirect" min="0" step="0.01" placeholder="<?= __('Hoa hồng gián tiếp') ?>">
                                </div>
                                <p class="error-message"></p>
                            </div>
                            <div class="col-md-3 mb-3">
