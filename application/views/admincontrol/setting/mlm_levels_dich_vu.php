<?php if($mlm_status){ ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="tab-content">
                            <?php $levels = isset($referlevel_dich_vu['levels']) ? (int)$referlevel_dich_vu['levels'] : 3; ?>
                            <div class="form-group">
                                <label class="control-label"><?= __('admin.refer_level') ?></label>
                                <select class="form-control" id="referlevel_select" name="referlevel_dich_vu[levels]">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center border-end p-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <select class="form-control refer-symball-select w-100 mt-2" name="referlevel_dich_vu[sale_type]">
                                                            <option symbal='%' <?php if($referlevel_dich_vu['sale_type'] == 'percentage') { ?> selected <?php } ?> value="percentage"><?= __('admin.percentage') ?></option>
                                                            <option symbal='<?= $CurrencySymbol ?>' <?php if($referlevel_dich_vu['sale_type'] == 'fixed') { ?> selected <?php } ?>  value="fixed"><?= __('admin.fixed') ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-end">
                                                    <div class="input-group">
                                                        <input type="number" step="any" name="referlevel_<?= $level ?>_dich_vu[sale_commition]" value="<?php echo ${"referlevel_". $level ."_dich_vu"}['sale_commition'] ?>" class="form-control" />
                                                        <div class="input-group-append"><span class="input-group-text refer-symball"></span></div>
                                                    </div>
                                                </td>
                                                <td class="border-end"><input type="number" step="any" name="referlevel_<?= $level ?>_dich_vu[commition]" value="<?php echo ${"referlevel_". $level ."_dich_vu"}['commition'] ?>" class="form-control" /></td>
                                                <td class="border-end">
                                                    <div class="input-group">
                                                        <input type="number" step="any" name="referlevel_<?= $level ?>_dich_vu[ex_commition]" value="<?php echo ${"referlevel_". $level ."_dich_vu"}['ex_commition'] ?>" class="form-control" />
                                                        <div class="input-group-append"><span class="input-group-text"><?= $CurrencySymbol ?></span></div>
                                                    </div>
                                                </td>
                                                <td class="border">
                                                    <div class="input-group">
                                                        <input type="number" step="any" name="referlevel_<?= $level ?>_dich_vu[ex_action_commition]" value="<?php echo ${"referlevel_". $level ."_dich_vu"}['ex_action_commition'] ?>" class="form-control" />
                                                        <div class="input-group-append"><span class="input-group-text"><?= $CurrencySymbol ?></span></div>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="comm-cube-box">
                                                <div class="form-group">
                                                    ...
                                                    <input name="referlevel_dich_vu[click]" value="<?php echo $referlevel_dich_vu['click']; ?>" class="form-control" step="any" type="number" placeholder='<?= __('admin.no_of_click_per_commission') ?>'>
                                                </div>
                                                <?php foreach (array('1','2','3') as $key => $v) { ?>
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="referlevel_<?php echo $v ?>_dich_vu[commition]" value="<?php echo ${"referlevel_$v"}.'_dich_vu'.['commition']; ?>" class="form-control" step="any" type="number">
                                                        </div>
                                                    </fieldset>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="comm-cube-box">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control refer-symball-select" name="referlevel_dich_vu[sale_type]">
                                                        <option symbal='%' <?php if($referlevel_dich_vu['sale_type'] == 'percentage') { ?> selected <?php } ?> value="percentage"><?= __('admin.percentage') ?></option>
                                                        <option symbal='<?= $CurrencySymbol ?>' <?php if($referlevel_dich_vu['sale_type'] == 'fixed') { ?> selected <?php } ?>  value="fixed"><?= __('admin.fixed') ?></option>
                                                    </select>
                                                </div>
                                                <?php foreach (array('1','2','3') as $key => $v) { ?>
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="referlevel_<?php echo $v ?>_dich_vu[sale_commition]" value="<?php echo ${"referlevel_$v"}.'_dich_vu'.['sale_commition']; ?>" class="form-control" step="any" type="number">
                                                        </div>
                                                    </fieldset>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="comm-cube-box">
                                                <div class="form-group">
                                                    ...
                                                    <input name="referlevel_dich_vu[ex_click]" value="<?php echo $referlevel_dich_vu['ex_click']; ?>" class="form-control" step="any" type="number" placeholder='<?= __('admin.external_click') ?>'>
                                                </div>
                                                <?php foreach (array('1','2','3') as $key => $v) { ?>
                                                    <fieldset>
                                                        <legend><?= __('admin.level') ?> <?= $v ?>:</legend>
                                                        <div class="form-group">
                                                            ...
                                                            <input name="referlevel_<?php echo $v ?>_dich_vu[ex_commition]" value="<?php echo ${"referlevel_$v"}.'_dich_vu'.['ex_commition']; ?>" class="form-control" step="any" type="number">
                                                        </div>
                                                    </fieldset>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="comm-cube-box">
                                                <div class="form-group">
                                                    ...
                                                    <input name="referlevel_dich_vu[ex_action_click]" value="<?php echo $referlevel_dich_vu['ex_action_click']; ?>" class="form-control" step="any" type="number" placeholder='External Action Click'>
                                                </div>
                                                <?php foreach (array('1','2','3') as $key => $v) { ?>
                                                    <fieldset>
                                                        <legend><?= __('admin.level') ?> <?= $v ?>:</legend>
                                                        <div class="form-group">
                                                            ...
                                                            <input name="referlevel_<?php echo $v ?>_dich_vu[ex_action_commition]" value="<?php echo ${"referlevel_$v"}.'_dich_vu'.['ex_action_commition']; ?>" class="form-control" step="any" type="number">
                                                        </div>
                                                    </fieldset>
                                                <?php } ?>
                                            </div>
                            ...
                            <script type="text/javascript">
                                ...
                                function chnage_teigger2() {
                                    ...
                                    if($(".refer-reg-symball-select").val() != "custom_percentage") {
                                        $('input[name="referlevel_dich_vu[reg_comission_custom_amt]"]').hide();
                                    } else {
                                        $('input[name="referlevel_dich_vu[reg_comission_custom_amt]"]').show();
                                    }
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").on('click',function(evt){
            if($(".refer-reg-symball-select").val() == "custom_percentage") {
                let reg_comission_custom_amt = $('input[name="referlevel_dich_vu[reg_comission_custom_amt]"]').val();
        ...
        $('#referlevel_select').on('change',function(){
            ...
            for(var i = 1; i <= level; i++){
                ...
                // html += '<td style="border-right: 1px solid lightgrey;"><div class="input-group"><input type="number" step="any" name="referlevel_'+i+'_dich_vu[reg_commission]" value="'+(levels[i] ? levels[i]['reg_commission'] : '' )+'" class="form-control" /><div class="input-group-append"><span class="input-group-text refer-reg-symball"></span></div>															</div></td>';
                html += '<td style="border-right: 1px solid lightgrey;"><div class="input-group"><input type="number" step="any" name="referlevel_'+i+'_dich_vu[sale_commition]" value="'+(levels[i] ? levels[i]['sale_commition'] : '' )+'" class="form-control" /><div class="input-group-append"><span class="input-group-text refer-symball"></span></div>															</div></td>';
                html += '<td><input type="number" step="any" name="referlevel_'+i+'_dich_vu[commition]" value="'+(levels[i] ? levels[i]['commition'] : '' )+'" class="form-control" /></td>';
                html += '<td style="border-right: 1px solid lightgrey;"><div class="input-group"><input type="number" step="any" name="referlevel_'+i+'_dich_vu[ex_commition]" value="'+(levels[i] ? levels[i]['ex_commition'] : '' )+'" class="form-control" /><div class="input-group-append"><span class="input-group-text"><?= $CurrencySymbol ?></span></div></div></td>';
