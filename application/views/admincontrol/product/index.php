                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="product_tab">
                        ...
                        <div class="table-rep-plugin">
                            <div class="row">
                                       ...
                                       <li><?= __('admin.ip_product_variations_desc_2') ?></li>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ul>
                                                                                ...
                                                                                <li><?= __('admin.ip_allow_shipping_desc_2') ?>
                                                                                    t
                                                                                </li>
                                                                                <ul>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ul>
                                                                                <li><?= __('admin.required') ?></li>
                                                                                <li><?= __('admin.ip_allow_on_store_desc_1') ?>
                                                                                    )
                                                                                </li>
                                ...
                                <div id="manageBulkProductsConfirmation" class="modal fade bd-example-modal-lg"
                                ...
                                <div id="manageBulkProductsResult" class="modal fade bd-example-modal-lg" tabindex="-1"
                                     role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-lg btn-default btn-success text-center"
                                                        id="bulkokbutton"
                                                        onclick="window.location.reload()"><?= __('admin.ok') ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php } else { ?>
                                ...
                                <form method="post" name="deleteAllproducts" id="deleteAllproducts"
                                      action="<?php echo base_url('admincontrol/deleteAllproducts'); ?>">
                        ...
                        <div class="table-rep-plugin">
                            <div class="pull-right mb-2 mt-2">
                                <a class="btn btn-primary"
                                   href="<?= base_url('admincontrol/coupon_manage/') ?>"><?= __('admin.add_new'); ?></a>
                            </div>
                            <?php if ($coupons == null) { ?>
                                <div class="text-center">
                                    <div class="d-flex justify-content-center align-items-center flex-column">
                                        ...
                                        <table id="table-coupons" class="table table-striped">
                                            ...
                                            <?php foreach ($coupons as $coupon) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('admincontrol/coupon_manage/' . $coupon['coupon_id']) ?>"
                                                           class="btn btn-primary edit-button"
                                                           id="<?= $coupon['id'] ?>"><?= __("admin.edit") ?></a>
                                                        <a href="<?= base_url('admincontrol/coupon_delete/' . $coupon['coupon_id']) ?>"
                                                           class="btn btn-danger delete-button"
                                                           id="<?= $coupon['id'] ?>"><?= __("admin.delete") ?></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
                    ...
                    <div role="tabpanel" class="tab-pane" id="form_tab">
                        <div class="table-rep-plugin">
                            <div class="pull-right mb-2 form-tab-main">
                                <button style="display:none;" type="button" class="btn btn-info" name="deletebuttonform"
                                        id="deletebuttonform" value="<?= __('admin.save_exit') ?>"
                                        onclick="deleteformfunc('deleteAllforms');"><?= __('admin.delete_products') ?></button>
                                <a class="btn btn-primary"
                                   href="<?= base_url('admincontrol/form_manage/') ?>"><?= __('admin.add_new'); ?></a>
                            </div>
                            ...
                            <?php } else { ?>
                                <div class="table-responsive b-0" data-pattern="priority-columns">
                                    <form method="post" name="deleteAllforms" id="deleteAllforms"
                                          action="<?php echo base_url(); ?>admincontrol/deleteAllforms">
                                            ...
                                            <?php foreach ($forms as $form) { ?>
                                                <tr>
                                                    <td><input name="checkbox[]" type="checkbox"
                                                               id="check<?php echo $form['form_id']; ?>"
                                                               value="<?php echo $form['form_id']; ?>"
                                                               onclick="checkonly(this,'check<?php echo $form['form_id']; ?>')">
                                                    </td>
                                                    <td>
                                                        <?= $form['title'] ?>
                                                        <div><small>
                                                                <a href="<?= $form['public_page'] ?>"
                                                                   target='_black'><?= __('admin.public_page'); ?></a>
                                                            </small>
                                                        </div>
                                                        <?php
                                                    ...
                                                    <td><?= (int)$form['count_commission'] . ' / ' . c_format($form['total_commission']) ?>
                                                        <br/><br/>
                                                    ...
                                                    <td><?= (int)$form['commition_click_count'] . ' / ' . c_format($form['commition_click']); ?>
                                                        <br/><br/>
                                                        <b><?= __('admin.view') ?> / <?= __('admin.ratio') ?></b><br/>
                                                        <?php
                                                        $ordercountratio = 0;
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('admincontrol/form_manage/' . $form['form_id']) ?>"
                                                           class="btn ml-0 btn-primary edit-button"
                                                           id="<?= $lang['id'] ?>"><?= __("admin.edit") ?></a>
                                                        <button data-href="<?= base_url('admincontrol/form_delete/' . $form['form_id']) ?>"
                                                                class="btn ml-0 btn-danger delete-form-button"
                                                                id="<?= $lang['id'] ?>"><?= __("admin.delete") ?></button>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
                    ...
                    <div role="tabpanel" class="tab-pane" id="form_coupons_tab">
                        <div class="table-rep-plugin">
                            <div class="pull-right mb-2">
                                <a class="btn btn-primary"
                                   href="<?= base_url('admincontrol/form_coupon_manage/') ?>"><?= __('admin.add_new'); ?></a>
                            </div>
                                    ...
                                    <table class="table  table-striped">
                                        ...
                                        <?php foreach ($form_coupons as $form_coupon) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('admincontrol/form_coupon_manage/' . $form_coupon['form_coupon_id']) ?>"
                                                       class="btn btn-primary edit-button"
                                                       id="<?= $lang['id'] ?>"><?= __("admin.edit") ?></a>
                                                    <button data-href="<?= base_url('admincontrol/form_coupon_delete/' . $form_coupon['form_coupon_id']) ?>"
                    ...
                    <div role="tabpanel" class="tab-pane" id="review_tab">
                        <div class="table-rep-plugin">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <select id="product_name_review" name="product_name_review"
                                                        class="form-control">
                                        ...
                                        <div class="col-2">
                                            <div class="form-group">
                                                <button class="btn btn-primary"><?= __('admin.total_review') ?> : <span
                                                            id="total_review"></span></button>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                        </div>
                                        <div class="col-3">
                                            <div class="pull-right mb-2">
                                                <a class="btn btn-primary"
                                                   href="<?= base_url('admincontrol/manage_review/') ?>"><?= __('admin.add_new'); ?></a>
                                                <a class="btn btn-primary" href="javascript:void(0)"
                                                   data-bs-toggle="modal"
                                                   data-bs-target="#manageBulkReviews"><?= __('user.manage_bulk_reviews') ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div id="manageBulkReviews" class="modal fade" tabindex="-1" role="dialog"
                                 aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <div class="row g-4 mb-4 px-3">
                                                <div class="col-12">
                                                    ...
                                                    <ul class="nav nav-pills flex-column flex-sm-row mb-4" id="TabsNav">
                                                        <li class="nav-item flex-sm-fill text-sm-center">
                                                            <a class="nav-link active" id="import-review-file-tab"
                                                               data-bs-toggle="tab" href="#import_review_file_tab_"
                                                               role="tab" aria-controls="import_review_file_tab_"
                                                               aria-selected="true"><?= __('admin.import_from_file') ?></a>
                                                        </li>
                                                        <li class="nav-item flex-sm-fill text-sm-center">
                                                            <a class="nav-link" id="import-review-link-tab"
                                                               data-bs-toggle="tab" href="#import_review_link_tab"
                                                               role="tab" aria-controls="import_review_link_tab"
                                                               aria-selected="false"><?= __('admin.import_from_url') ?></a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade show active p-4"
                                                             id="import_review_file_tab_" role="tabpanel"
                                                             aria-labelledby="import-review-file-tab">
                                                            <form id="bulk_reviews_form" class="text-center">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <label class="input-group-text"
                                                                           for="customFile"><?= __('admin.upload_xml_file_for_bulk_review_manage') ?></label>
                                                                </div>
                                                                <button id="bulk_reviews_form_btn" type="submit"
                                                                        class="btn btn-lg btn-success"><?= __('admin.import_reviews') ?></button>
                                                            </form>
                                                        </div>
                                                        <div class="tab-pane fade p-4 m-2" id="import_review_link_tab"
                                                             role="tabpanel" aria-labelledby="import-review-link-tab">
                                                            <form id="bulk_reviews_form_url" class="text-center">
                                                                <div class="input-group mb-3">
                                                                    <input name="txt_review_xmlurl"
                                                                           id="txt_review_xmlurl"
                                                                           class="form-control textxmlurl" type="text"
                                                                           placeholder="<?= __('admin.enter_xml_url_for_bulk_review_manage') ?>">
                                                                </div>
                                                                <button id="bulk_reviews_form_url_btn" type="submit"
                                                                        class="btn btn-lg btn-success"><?= __('admin.import_reviews') ?></button>
                                                            </form>
                                                        </div>
                                                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-lg btn-secondary text-center"
                        data-bs-dismiss="modal"><?= __('admin.cancel') ?></button>
            </div>
        </div>
    </div>
    ...
    $('#bulk_products_form_btn').on('click', function (e) {
        ...
        if (category_id) {
            if ($('#bulk_products_form input[name="file"]').val()) {
                ...
                $("#bulk_products_form .alert-form").after('<div class="alert alert-danger"><?= __('admin.please_select_excel_file') ?></div>');
            }
        }else
            {
                $("#bulk_products_form .alert-select").after('<div class="alert alert-danger"><?= __('Vui lòng chọn danh mục sản phẩm') ?></div>');
            }
        }
    )
        ;
        ...
        $('#manageBulkProductsConfirmation .import-products-confirm').on('click', function (e) {
            ...
            if ($('#manageBulkProductsConfirmation textarea[name="product_for_import"]').val()) {
                ...
                data.append('category_id', $('#manageBulkProductsConfirmation textarea[name="category_for_import"]').val());
                $.ajax({
