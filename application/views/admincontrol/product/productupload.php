							...
							<div class="form-group form-image-group">
								<div>
									...
									<div class="col-sm-9">
										...
										<?php $product_multiple_image = 'no_image_available.png' ; ?>
										<img src="<?php echo base_url();?>assets/images/<?php echo $product_multiple_image; ?>" id="multipleimage" class="thumbnail" border="0" width="220px">
									</div>
								</div>
							</div>
