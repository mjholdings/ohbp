...
<div class="card-header bg-secondary text-white">
	<div class="card-title-white pull-left m-0"><?= (int)$product->product_id == 0 ? __('admin.lbl_create_product') : __('admin.lbl_update_product') ?></div>
</div>
<div class="card-body">
...
<div class="card ">
	...
	<div class="card-body">
		...
		<?php } ?>
			...
			<?php if($seller){ ?>
				<div class="card mt-3">
					<div class="card-header change-category-color"><h4 class="header-title"><?= __('admin.admin_comments') ?></h4></div>
