...
$wallet = (float)$this->db->query("SELECT SUM(total) as total FROM `order` WHERE status= 1 AND user_id=". (int)$userdetails['id'])->row()->total;
          ...
          <div class="accordion-header" id="headingOne">
            <div class="market-heade">
              <ul>
                ...
                <li class="offer-text">
                  <?php 
                        if($product['seller_id']){
                          ...
                          }else if($product['product_commision_type'] == 'category'){
                              if($award_level_status == 1 && $userComission['status'] && $userComission['value'] && $userComission['value'] < $product['product_commision_value'])
                                  $product_commision_value = $userComission['value'];
                              else if(!empty($product['cat_value']))
                                  $product_commision_value = $product['cat_value'];
                              else
                                  $product_commision_value = $product['product_commision_value'];
                              echo $product_commision_value. "% ".__('user.per_sale');
                          }
                ...
                <li>
                    <?php if($wallet >= $site_wallet['wallet_unlock_amount_affiliate']){?>
                        <div class="flex align-items-center list-user-action">
