...
$wallet = (float) $this->db->query("SELECT SUM(total) as total FROM `order` WHERE status= 1 AND user_id=" . (int) $loginUser['id'])->row()->total;
$product_id = (float) $this->db->query("SELECT order_products.product_id as product_id FROM `order` INNER JOIN order_products ON `order`.`id` = order_products.order_id WHERE order_products.product_id = 126 AND `order`.`status` = 1 AND `order`.`user_id` =" . (int) $loginUser['id'])->row()->product_id;
$site_wallet = $db->Product_model->getSettings('site');
$productForAffiliate = $db->Product_model->getProductForAffiliate();
?>
            ...
            <div>
              <div class="badge bg-primary">
                ...
                <span>
                  ...
                  <?= ($userdetails['is_vendor']) ? c_format($user_totals['vendor_action_external_commission_pay']) : '' ?>
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-6 mx-sm-auto mt-3 mt-sm-0">
              <select onchange="loadDashboardChart()" class="yearSelection chart-input form-control" name="year">
                <?php for ($i = 2016; $i <= date("Y"); $i++) { ?>
                  <option value="<?= $i ?>" <?php echo $i == date("Y") ? "selected='selected'" : '' ?>>
                    <?= $i ?>
                  </option>
                <?php } ?>
              </select>
                  ...
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['wallet_on_hold_amount']) ?>
                  ...
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['wallet_unpaid_amount']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['wallet_request_sent_amount']) ?>
                  ...
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['wallet_cancel_amount']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['wallet_trash_amount']) ?>
                      </span>
                    </div>
                  </div>
                  <a href="<?= base_url('usercontrol/mywallet') ?>" class="btn btn-info  mb-2">
                    <?= __('user.check_all_transactions') ?>
                  </a>
                  <a href="<?= base_url('usercontrol/mywallet') ?>" class="btn btn-info mb-2">
                    <?= __('user.click_here') ?>
                  </a>
            ...
            <div class="col">
              <div class="card mb-3 rounded-3 shadow-sm">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['click_localstore_commission']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['click_external_commission']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['click_form_commission']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['vendor_click_localstore_commission_pay']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['vendor_click_external_commission_pay']) ?>
                  ...
                  <a href="<?= base_url('usercontrol/mywallet') ?>" class="btn btn-info mb-2 mt-sm-4">
                    <?= __('user.check_all_transactions') ?>
                  </a>
                  <a href="<?= base_url('usercontrol/mywallet') ?>" class="btn btn-info mb-2 mt-sm-4">
                    <?= __('user.click_here') ?>
            ...
            <div class="col">
              <div class="card mb-3 rounded-3 shadow-sm">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['sale_localstore_commission']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['order_external_commission']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['vendor_sale_localstore_commission_pay']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                    ...
                    <div>
                      <span>
                        ...
                        /
                        <?= c_format($user_totals['vendor_order_external_commission_pay']) ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between align-items-center my-3">
                  ...
                  <a href="<?= base_url('usercontrol/mywallet') ?>" class="btn btn-info  mb-2 mt-sm-5">
                    <?= __('user.check_all_transactions') ?>
                  </a>
                  <a href="<?= base_url('usercontrol/mywallet') ?>" class="btn btn-info mb-2 mt-sm-5">
                    <?= __('user.click_here') ?>
              ...
              <div class="col">
                <div class="card mb-3 rounded-3 shadow-sm">
                  <div class="card-body">
                    <h4 class="my-0 fw-normal">
                      <b>
                        <?= __('user.refered_levels') ?>
                      </b>
                    </h4>
                    <div class="d-flex justify-content-between align-items-center my-3">
                      <div>
                        <span>
                          <?= __('user.product_click') ?>
                        </span>
                      </div>
                      <div>
                        <span>
            ...
            <div class="col">
              <div class="card mb-3 rounded-3 shadow-sm">
                <div class="card-body">
                  <h4 class="my-0 fw-normal">
                    <b>
                      <?= __('Thưởng theo doanh số cá nhân') ?>
                    </b>
                  </h4>
                  <br />
                  <table id="user_reward_table" class="table table-hover">
                    ...
                    <tbody>
                      <?php foreach ($user_reward as $date => $value) { ?>
                        <tr>
                          <td>
                            <?= __($date) ?>
                          </td>
            ...
            <div class="col">
              <div class="card mb-3 rounded-3 shadow-sm">
                <div class="card-body">
                  <h4 class="my-0 fw-normal">
                    <b>
                      <?= __('Thưởng theo doanh số nhánh') ?>
                    </b>
                  </h4>
                  <br />
                  <table id="branch_reward_table" class="table table-hover">
                    <thead class="thead-light">
                      <tr>
                        <th>
                          <?= __('Thời gian') ?>
                    ...
                    <tbody>
                      <?php foreach ($branch_reward as $date => $value) { ?>
                        <tr>
                          <td>
                            <?= __($date) ?>
                          </td>
    ...
    <div class="col-md-12 col-xl-4 mt-3">
              ...
              <div class="card-body">
                <div class="d-flex align-itmes-center justify-content-between flex-wrap  mb-4">
                  <div class="d-flex align-itmes-center me-0 me-md-4">
                    ...
                    <div class="ms-1">
                      <h5>
                        <?= c_format($user_totals['vendor_order_external_total']) ?>
                      </h5>
                      <small class="mb-0">
                        <?= __('user.external_sales') ?>
                      </small>
                    </div>
                  </div>
                  <div class="d-flex align-itmes-center">
                    ...
                    <div class="ms-1">
                      <h5>
                        <?= c_format($user_totals['vendor_sale_localstore_total']) ?>
                      </h5>
                      <small class="mb-0">
                        <?= __('user.local_store') ?>
                      </small>
                ...
                <div class="mb-4">
                  <div class="d-flex justify-content-between flex-wrap">
                    <h2 class="mb-2">
                      <?= c_format($user_totals['vendor_sale_localstore_total'] + $user_totals['vendor_order_external_total']) ?>
                    </h2>
                  </div>
                  <p class="text-info">
                    <?= __('user.total_sale') ?>
                ...
                <div class="d-grid grid-cols-2 gap-card">
                  <button class="btn btn-primary text-uppercase p-2">
                    <?= __('user.summary') ?>
                  </button>
                  <button class="btn btn-info text-uppercase p-2">
                    <?= __('user.analytics') ?>
                  </button>
                </div>
              </div>
              ...
              <div class="card-header">
                <?php if ((isset($is_lifetime_plan) && $is_lifetime_plan) || !$isMembershipAccess) { ?>
                  ...
                  <div class="card-body text-center">
                    ...
                    <p>
                      <?= __('user.lifetime_free_membership_access_all_system_functions') ?>
                    </p>
                  </div>
                <?php } ?>
                <?php if (isset($plan) && $plan) {
                  ...
                  if ($plan->remainDay() != 'lifetime' && $plan->remainDay() <= $checkDay && !$plan->is_lifetime && $isMembershipAccess) { ?>
                    <div class="membership-alert">
                      ...
                      <span data-time-remains="<?= $plan->strToTimeRemains(); ?>">
                        <?= $plan->remainDay() ?>
                      </span>
      ...
      <div class="col-lg-12 mt-3">
              ...
              if ($invitationlinkid == 0) {
                ...
                <div class="card-header flex justify-content-between">
                  <div class="row">
                    <div class="col-md-8">
                      <div class="header-title">
                        <h4 class="card-title mb-md-0 mb-3">
                          <?= __('user.your_affiliate_id') ?> :
                          <?= $userdetails['id'] ?>
                        </h4>
                      </div>
                    </div>
        ...
        <?php if (isShowUserControlParts($userdashboard_settings['top_affiliate']) && allowMarketVendorPanelSections($marketvendorpanelmode, $userdetails['is_vendor'])) { ?>
          <div class="col-md-12 col-lg-12">
            <div class="card ">
              <h4 class="card-title my-3 ms-3">
                <?= __('user.popular_affiliates') ?>
              </h4>
              ...
              <div class="card-body">
                <?php foreach ($populer_users as $key => $users) {
                  ...
                  <div class="d-flex flex-wrap align-items-center justify-content-between">
                    <div class="col-sm-9 col-lg-9" style="text-align: left;">
                    ...
                    <!-- <div class="col-sm-4 col-lg-4" style="text-align: right;">
                          <span class="text-danger"><?= c_format($users['all_commition']); ?></span>
                        </div>-->
                  </div>
...
<div class="modal fade" id="model-codemodal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered  scanner">
    <div class="modal-content ">
      <div class="modal-header">
        <h5 class="modal-title exampleModalLabel2">
          <?= __('user.scanner') ?>
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
    ...
    <div class="modal-content ">
      <form action="<?= base_url('/usercontrol/create_slug') ?>" method="post">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary btn-delete-slug">
            <?= __('user.delete'); ?>
          </button>
        </div>
      </form>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" onclick="return closeWelcomePopup()">
            <?= __('user.close_forever') ?>
          </button>
        </div>
      </div>
    </div>
