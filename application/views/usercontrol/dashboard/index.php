<?php
    ...
    ?>
<script type="text/javascript" src="<?= base_url('assets/plugins/chartist/js/chartist.min.js') ?>"></script>
<link rel="stylesheet" type="text/css" href="<?= base_url('/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.css') ?>">
<link href="<?php echo base_url('assets/plugins/chartist/css/chartist.min.css'); ?>?v=<?= av() ?>" rel="stylesheet" type="text/css">
<script src="<?= base_url('assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js') ?>"></script>
<script src="<?= base_url('assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') ?>"></script>
<script src="<?= base_url('assets/plugins/jvectormap/gdp-data.js') ?>"></script>
<script src="<?= base_url('assets/plugins/jvectormap/jquery-jvectormap-us-aea-en.js') ?>"></script>
<script src="<?= base_url('assets/plugins/jvectormap/jquery-jvectormap-uk-mill-en.js') ?>"></script>
<script src="<?= base_url('assets/plugins/jvectormap/jquery-jvectormap-us-il-chicago-mill-en.js') ?>"></script>
            ...
            <li class="list-group-item list-group-item-white font-weight-bold" style="text-align:center;"><?php echo __('user.user_statistics') ?></li>
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center btn-window2" data-log="hold_actions" style='width: 50px;right:0;'>
                            <?= (int)$totals['full_hold_action_count'] ?></span>
                    </li>

                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <a href="<?= base_url('usercontrol/store_orders/') ?>">  <?= __('user.vendor_orders') ?> </a></span>
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center" style='width: 50px;right:0;'><?= (int)$totals['vendor_order_count'] ?></span>
                    </li>

                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <a href="<?= base_url('usercontrol/mywallet/') ?>">  <?= __('user.vendor_unpaid_amount') ?> </a></span>
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center" style='width: 50px;right:0;'><?= c_format($totals['vendor_wallet_unpaid_amount']) ?></span>
                    </li>

                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <a href="<?= base_url('usercontrol/mywallet/') ?>">  <?= __('user.vendor_on_hold amount') ?> </a></span>
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center" style='width: 50px;right:0;'><?= c_format($totals['vendor_wallet_on_hold_amount']) ?></span>
                    </li>

                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <a href="<?= base_url('usercontrol/mywallet/') ?>">  <?= __('user.vendor_paid_amount') ?> </a></span>
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center" style='width: 50px;right:0;'><?= c_format($totals['vendor_wallet_accept_amount']) ?></span>
                    </li>

                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <a href="<?= base_url('usercontrol/mywallet/') ?>">  <?= __('user.vendor_in_request_amount') ?> </a></span>
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center" style='width: 50px;right:0;'><?= c_format($totals['vendor_wallet_request_sent_amount']) ?></span>
                    </li>
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center btn-window2" data-log="hold_orders" style='width: 50px;right:0;'>
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center btn-window2" data-log="orders" style='width: 50px;right:0;'>
                     ...
                     <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="counter mt-0 badge bg-primary cursor-pointer badge-pill float-center btn-window2" data-log="ex_orders" style='width: 50px;right:0;'>
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-primary badge-pill ajax-_t_paid_comm"><?php echo c_format($_t_paid_comm) ?></span>
                    </li>
                      
                      
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <?= __('user.total_unpaid_commition') ?>
                        <span class="badge bg-primary badge-pill ajax-_t_unpaid_comm"><?php echo c_format($_t_unpaid_comm) ?></span>
                    </li>
                      
                      
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <?= __('user.total_in_request_commition') ?>
                        <span class="badge bg-primary badge-pill ajax-_t_request_comm"><?php echo c_format($_t_request_comm) ?></span>
                    </li>
                      
                      
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                       <?= __('user.total_affiliates_comm') ?>
                        <span class="badge bg-primary badge-pill ajax-_t_total_commission"><?php echo c_format($_t_total_commission) ?></span>
                    </li>
                      <!----------End---------->
                            ...
                            <table id="product-list" class="table table-no-wrap">
                                    ...
                                    <?php foreach($data_list as $index => $product){ ?>
                                        ...
                                        <?php if(isset($product['is_form'])){ ?>
                                            <tr class="<?= $display_class ?>">
                                                ...
                                                <td><img width="50px" height="50px" src="<?php echo base_url('assets/images/share-icon.png') ?>" ></td>
                                                <td>
                                                    <?= $product['title'] ?>
                                                    <div>
                                                        <small>
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($product['sale_commision_type'] == 'default'){
                                                            ...
                                                            if($form_default_commission['product_commission_type'] == 'percentage'){
                                                                echo $form_default_commission['product_commission'] .'% '.__('user.per_sale');
                                                            }
                                                            ...
                                                            echo $product['sale_commision_value'] .'% '.__('user.per_sale');
                                                        }
                                                            ...
                                                            if($product['form_recursion_type']){
                                                                if($product['form_recursion_type'] == 'custom'){
                                                                    if($product['form_recursion'] != 'custom_time'){
                                                                        echo '<b>'.__('user.recurring').' </b> : ' . $product['form_recursion'];
                                                                    } else {
                                                                    ...
                                                                    if($form_setting['form_recursion'] == 'custom_time' ){
                                                                        ...
                                                                        echo '<b>'.__('user.recurring').' </b> : '. $form_setting['form_recursion'];
                                                                    }
                                                                }
                                                            }
                                                        ?>
                                                            ...
                                                            if($product['product_recursion_type']){
                                                                if($product['product_recursion_type'] == 'custom'){
                                                                    if($product['product_recursion'] != 'custom_time'){
                                                                        echo '<b>'.__('user.recurring').' </b> : ' . $product['product_recursion'];
                                                                    } else {
                                                                        echo '<b>'.__('user.recurring').' </b> : '. timetosting($product['recursion_custom_time']);
                                                                    }
                                                                } else{
                                                                    if($pro_setting['product_recursion'] == 'custom_time' ){
                                                                        ...
                                                                        echo '<b>'.__('user.recurring').' </b> : '. $pro_setting['product_recursion'];
                                                                    }
                                                                }
                                                            }
                                                        ?>
                                        ...
                                        <?php } else{ ?>
                                            <tr class="<?= $display_class ?>">
                                                <td><button type="button" class="toggle-child-tr"><i class="fa fa-plus"></i></button></td>
                                                  <td><img width="50px" height="50px" src="<?php echo base_url('assets/images/product/upload/thumb/'. $product['featured_image']) ?>" ></td>
                                                <td>
                                                    <?= $product['name'] ?>
                                                    <div>
                                                        <small>
                                                ...
                                                <td>
                                                    <div class="wallet-toggle ">
                                                        <div class="<?= $product['_tool_type'] == 'program' && $product['sale_status'] ? '' : 'd-none' ?>">
                                                            <?php 
                                                                ...
                                                                echo "<b>".__('user.you_can_earn')." :</b><small> {$comm} ".__('user.per_sale')." </small><br>";
                                                                ?>
                                                        </div>
                                                    </div>
                                                    <div class="wallet-toggle ">
                                                        <div class="<?= $product['_tool_type'] == 'program' && $product['click_status'] ? '' : 'd-none' ?>">
                                                            <?php 
                                                                echo "<b>".__('user.you_can_earn')." :</b><small> ";
                                                    ...
                                                    <div class="wallet-toggle ">
                                                        <div class="<?= $product['_tool_type'] == 'general_click' ? '' : 'd-none' ?>">
                                                            <?php 
                                                                echo "<b>".__('user.you_can_earn')." :</b><small> ";
                                                                echo c_format($product["general_amount"]). " ".__('user.per')." ". $product['general_click'] ." ".__('user.general_clicks')." </small><br>";
                                                                ?>
                                                        </div>
                                                    </div>
                                                    <div class="wallet-toggle ">
                                                    ...
                                                    <?php 
                                                        if($product['recursion']){
                                                            if($product['recursion'] != 'custom_time'){
                                                                echo '<b>'.__('user.recurring').' </b> : ' . $product['recursion'];
                                                            } else {
                                                                echo '<b>'.__('user.recurring').' </b> : '. timetosting($product['recursion_custom_time']);
                                                            }
                                                        }
                                                        ...
                                                        <ul>
                                                            ...
                                                            <?php 
                                                                ...
                                                                if($product['_tool_type'] == 'action'){
                                                                    ...
                                                                    echo "<li><b>".__('user.action_amount')." :</b> <span>". $tool['total_action_click_amount'] ."</span></li>";
                                                                }
                                                            ?>
                                                        </ul>
                                                    </div>
                                ...
                                <?php if($index >= $pagination){ ?>
                                    <tfoot>
                                        <tr>
                                            <td colspan="10%">
                                                <button type="button" class="btn btn-primary show-more"><?= __('user.show_more') ?></button>
                                            </td>
                                        </tr>
                                    </tfoot>
                                <?php } ?>
                        ...
                        <tbody>
                            <?php foreach ($populer_users as $key => $users) { ?>
                                <tr class="<?= $key == 0 ? 'bg-primary text-white' : '' ?>">
                                    ...
                                    <td><?php echo c_format($users['amount']); ?> </br><?= __('user.sales') ?></td>
                                    <td><?php echo c_format($users['all_commition']); ?></br><?= __('user.commissions') ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-20">
            <div class="card-body">
                <h4 class="mt-0 header-title"><?= __('user.your_unique_reseller_link') ?> ( <?= __('user.your_affiliate_id') ?> : <?= $userdetails['id'] ?> ) </h4>
                <div class="card-body">
